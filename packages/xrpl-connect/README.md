# @xrpl-lending-network/network-wallet-core
...
> that's a different concern — this package doesn't touch it. `@xrpl-lending-network/network-wallet-core` here is for
...
{
  "dependencies": {
    "@xrpl-lending-network/network-wallet-core": "workspace:*"
  }
}
```
...
```typescript
import { Address, Accounts, Payments } from '@xrpl-lending-network/network-wallet-core';
