...
```bash
pnpm add xrpl-connect@0.8.2 xrpl
```

### Using yarn

```bash
yarn add xrpl-connect@0.8.2 xrpl
```
...
- **[Vanilla JavaScript](/0.8.2/guide/frameworks/vanilla-js)** - Pure JavaScript, no framework
- **[React](/0.8.2/guide/frameworks/react)** - Complete React integration guide
- **[Vue 3](/0.8.2/guide/frameworks/vue)** - Vue 3 Composition API guide
- **[Nuxt](/0.8.2/guide/frameworks/nuxt)** - Nuxt 3 and Nitro integration
...
- **[Concepts](/0.8.2/concepts)** - Understand WalletManager, adapters, and web components
- **[Try It Out](/0.8.2/try-it-out)** - See the wallet connector in action
- **[Customization](/0.8.2/guide/customization)** - Style the component with CSS variables
- **[API Reference](/0.8.2/guide/api-reference)** - Complete API documentation
