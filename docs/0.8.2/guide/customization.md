...
Want to see your customizations in real-time? Check out the **[Customization Builder](/0.8.2/customization-builder)** page where you can interactively customize colors and see the changes instantly!
...
For advanced customization beyond CSS variables, check out the [API Reference](/0.8.2/guide/api-reference) for component methods and events you can use to build custom UI.
